...
COMMIT_NUMBER = '$(shell git rev-list --count HEAD 2>/dev/null || git rev-list --all | wc -l)'
...
init: initialize-python-environment dependencies init-workflow package.json dotenv
