...
build-gui: clean-app clean-all libdraw2D.so resource-file ui-files autogenerated-constants
	...
	pyinstaller --onefile \
	            ...
	            --noconfirm \
	            --add-data="../README.md:." \
	            --add-data="$(EXAMPLES_FOLDER)/APS.xml:$(APP_EXAMPLES)" \
	            --add-data="$(EXAMPLES_FOLDER)/rms_project_data_for_APS_gui.xml:$(APP_EXAMPLES)" \
