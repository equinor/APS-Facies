...
import { DependentConfiguration, DependentSerialization } from '@/utils/domain/bases/zoneRegionDependent'
...
export default abstract class Simulation extends ZoneRegionDependent {
  ...
  protected constructor ({ simulation = null, _dataHash = '', ...rest }: SimulationConfiguration) {
    super(rest)

    this._simulation = simulation
    this._dataHash = _dataHash
    this._excludeFromHash.push(...[
      '_dataHash',
      'simulation'
    ])
  }
