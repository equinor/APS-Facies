...
import type { AvailableOptionSerialization, SelectableOptionSerialization, SelectableSerialization } from './helpers'
import {
  serializeOptionStore
} from './helpers'
...
export function useParameterStoreSerialization(): ParameterStoreSerialization {
    return {
        ...
        maxAllowedFractionOfValuesOutsideTolerance: {selected: useParametersToleranceOfProbabilityNormalisationStore().tolerance},
        debugLevel: {selected: useParameterDebugLevelStore().level},
        names: useParameterNameStoreSerialization(),
        probabilityCube: { available: useParameterProbabilityCubeStore().available },
        ...
        rmsTrendMapZones: { available: useParameterRmsTrendMapZoneStore().available },
        toleranceOfProbabilityNormalisation: { selected: useParametersToleranceOfProbabilityNormalisationStore().tolerance },
