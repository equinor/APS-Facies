...
title: Cubic
---
If "Cubic" truncation rule is selected, a drop down list of templates is available.
...
In this case the polygons have rectangular shape (two-dimensional when two Alpha's (GRF's) are used and rectangular boxes in 3 or more dimensions if overlay facies is used.
