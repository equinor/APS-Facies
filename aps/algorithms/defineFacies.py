...
def read_facies_prob_trend_model(project,
    ...
    if suffix in ['yaml', 'yml']:
        param_dict = _read_facies_prob_trend_model_yml(project,
            model_file_name,
            trend_keyword,
            debug_level = debug_level)
    elif suffix == 'xml':
        param_dict = _read_facies_prob_trend_model_xml(project,
            model_file_name,
            trend_keyword,
            debug_level=debug_level)
    else:
...
def _read_facies_prob_trend_model_yml(project,
        model_file_name: str,
        trend_keyword: str,
        debug_level: Debug = Debug.OFF
    ):
    ...
    facies_interpretation_param_name = get_text_value(spec, parent_kw, 'FaciesParamName')
...
def _read_facies_prob_trend_model_xml(project,
        model_file_name: str,
        trend_keyword: str,
        debug_level: Debug = Debug.OFF
    ):
