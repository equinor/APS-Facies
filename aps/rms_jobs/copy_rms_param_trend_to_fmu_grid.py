...
def get_trend_param_names_from_aps_model(
    ...
    for key, zone_model in all_zone_models.items():
        ...
        # Raise error if possible to check and specified layout is
        # inconsistent with grid layout.
        # Print warning if not possible to check.
        # Will then continue with the specified grid layout.
