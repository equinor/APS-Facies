...
def getKeyword(parent,keyword,parentKeyword='',
               modelFile=None,required=True):
    ...
    if required:
        if obj is None:
            raise ValueError('Missing keyword {} under keyword {} in model file {}'
                             ''.format(keyword,parentKeyword,modelFile)
            )

    return obj
    
def getTextCommand(parent,keyword,parentKeyword='',
                   defaultText=None,modelFile=None,required=True):
...
def getFloatCommand(parent,keyword,parentKeyword='',minValue=None,maxValue=None,
...
def getIntCommand(parent,keyword,parentKeyword='',minValue=None,maxValue=None,
                  defaultValue=None,modelFile=None,required=True):
