...
from PyQt5.QtWidgets import QCheckBox, QListWidget, QMainWindow, QPushButton, QWidget
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def wire_up_navigation(self):
        buttons = {
            ...
            MainWindowElements.RUN_PREVIEWER:           self.run_previewer,
    ...
    def run_previewer(self):
        # aps_model = self._state.get_aps_model()
        run_button = get_element(self, MainWindowElements.RUN_PREVIEWER)
        toggle_elements(False, run_button)
        run_previewer(model=ExampleFiles.MODEL.value, rms_data_file_name=ExampleFiles.RMS.value)
        toggle_elements(True, run_button)
