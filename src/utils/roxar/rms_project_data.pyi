...
class RMSData:
    ...
    def is_continuous(self, _property) -> bool: ...
    def get_grid_models(self) -> GridModels: ...
    def get_grid_model(self, name: str) -> GridModel: ...
    def get_grid_model_names(self) -> List[GridName]: ...
    def get_zone_parameters(self, grid_model_name: GridName) -> List[ZoneParameter]: ...
    ...
    def get_zones(self, grid_model_name: GridName, zone_parameter: ZoneParameter) -> List[Dict]: ...
    def get_regions(self, grid_model_name: str, zone_name: str, region_parameter: str) -> Properties: ...
    ...
    def calculate_average_of_probability_cube(self, grid_model_name: GridName, probability_cube_parameters: List[ProbabilityCubeParameter], zones: Optional[List[ZoneNumber]]=None) -> Dict[ProbabilityCubeParameter, Average]: ...
    ...
    @staticmethod
    def get_constant(_property: str, _type: str) -> Dict[str, float]: ...
    @staticmethod
    def get_options(_type: str) -> Union[List[VariogramName], List[TrendName], List[DirectionName], List[OriginTypeName]]: ...
    @staticmethod
    def get_code_names(_property: Property) -> List[CodeName]: ...
    @staticmethod
    def simulate_gaussian_field(name: str,variogram: Dict, trend: Dict, settings: Optional[Dict]) -> List[List[float]]: ...
