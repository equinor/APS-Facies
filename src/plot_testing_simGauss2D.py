...
if variogramType == VariogramType.GENERAL_EXPONENTIAL:
    gaussVector = simGaussField(iseed, nx, ny, xLength, yLength, variogramType,
                                mainRange, perpRange, (90.0 - azimuth), power, debug_level)
else:
    gaussVector = simGaussField(iseed, nx, ny, xLength, yLength, variogramType,
                                mainRange, perpRange, (90.0 - azimuth), debug_level)
x0 = 0.0
y0 = 0.0
